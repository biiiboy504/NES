                        ...
                        <div class="row">
                                <div class="col-4">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="text" value="{{$student_data->zip_code}}" name="zip_code" class="form-control mb-3" placeholder="Zip Code . . .">
                                    </div>
                                    <div class="col-4">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="text" value="{{$student_data->landline}}" name="landline" class="form-control mb-3" placeholder="Landline Number . . .">
                                    </div>
                                    <div class="col-4">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <input type="text" value="{{$student_data->height}}" name="height" class="form-control mb-3" placeholder="Height . . .">
                                    </div>
                                    <div class="col-3">
                                        <label for="">Weight (kg):</label>
                                        <input type="text" value="{{$student_data->weight}}" name="weight" class="form-control mb-3" placeholder="Weight . . .">
                                    </div>
                                    <div class="col-3">
                                        <label for="">Citizenship:</label>
                                        <input type="text" value="{{$student_data->citizenship}}" name="citizenship" class="form-control mb-3" placeholder="Citizenship . . .">
                                    </div>
                                    <div class="col-7">
                                        <label for="">Birth Place:</label>
                                        <input type="text" value="{{$student_data->birth_place}}" name="birth_place" class="form-control mb-3" placeholder="Birth Place . . .">
                                    </div>
                                    <div class="col-3">
                                        <label for="">Birthdate:</label>
                                        <input type="date" value="{{$student_data->birth_date}}" name="birth_date" class="form-control mb-3">
                                    </div>
                                    <div class="col-2 ">
                                        <label for="">Age:</label>
